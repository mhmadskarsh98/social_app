                        ...
                        <div class="acc-leftbar">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link active " id="nav-acc-tab" data-toggle="tab" href="#nav-acc"
                                    ...
                                    <i class="fas fa-user-cog"></i>Account Setting</a>
                                ...
                                <a class="nav-item nav-link" id="nav-notification-tab" data-toggle="tab"
                                    ...
                                    aria-selected="false"><i class="far fa-bell"></i>Notifications</a>
                                ...
                                <div class="acc-setting">
                                    ...
                                    <form action="{{ route('profile.update') }}" method="post"
                                        ...
                                        <div class="cp-field">
                                            <h5>First name </h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="first_name" @error('first_name') is-invalid
                                                    @enderror value="{{ old('first_name ', $profile->first_name) }}"
                                        ...
                                        <div class="cp-field">
                                            <h5>last name </h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="last_name" @error('last_name') is-invalid
                                                    @enderror value="{{ old('last_name ', $profile->last_name) }}"
                                        ...
                                        <div class="cp-field">
                                            <h5>birthday </h5>
                                            <div class="cpp-fiel">
                                                <input type="date" name="birthday" @error('birthday') is-invalid
                                                    @enderror value="{{ old('birthday', $profile->birthday) }}">
                                                @error('birthday')
                                                    <p class="invalid-feedback">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="cp-field">
                                            <h5>bio </h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="bio" @error('bio') is-invalid @enderror
                                                    value="{{ old('bio', $profile->bio) }}" placeholder="bio">
                                                @error('bio')
                                                    <p class="invalid-feedback">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="cp-field">
                                            <h5>hour rate </h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="hour_rate" @error('hour_rate') is-invalid
                                                    @enderror value="{{ old('hour_rate ', $profile->hour_rate) }}"
                                        ...
                                        <div class="cp-field">
                                            <h5>mobile </h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="mobile" @error('mobile') is-invalid @enderror
                                        ...
                                        <div class="cp-field">
                                            <h5>gender </h5>
                                            <div class="cpp-fiel">
                                                <input type="text" name="gender" @error('gender') is-invalid @enderror
                                        ...
                                        <div class="cp-field">
                                            <h5>avatar </h5>
                                            <div>
                                                <input type="file" name="avatar" @error('avatar') is-invalid @enderror>
                                            </div>
                                            @if ($profile->avatar)
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="{{ asset('front/images/pro-icon1.png') }}" alt="">
                                                        <div class="bx-info">
                                                            <h3>$5,145</h3>
                                                            <h5>Total Income</h5>
                                                        </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="{{ asset('front/images/pro-icon2.png') }}" alt="">
                                                        <div class="bx-info">
                                                            <h3>$4,745</h3>
                                                            <h5>Widthraw</h5>
                                                        </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="{{ asset('front/images/pro-icon3.png') }}" alt="">
                                                        <div class="bx-info">
                                                            <h3>$1,145</h3>
                                                            <h5>Sent</h5>
                                                        </div>
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-12">
                                                <div class="profile-bx-info">
                                                    <div class="pro-bx">
                                                        <img src="{{ asset('front/images/pro-icon4.png') }}" alt="">
                                                        <div class="bx-info">
                                                            <h3>130</h3>
                                ...
                                <div class="acc-setting">
                                    ...
                                    <div class="requests-list">
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="{{ asset('front/images/resources/r-img1.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="{{ asset('front/images/resources/r-img2.png') }}" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>John Doe</h3>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="{{ asset('front/images/resources/r-img3.png') }}" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>Poonam</h3>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="{{ asset('front/images/resources/r-img4.png') }}" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>Bill Gates</h3>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="{{ asset('front/images/resources/r-img5.png') }}" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>Jessica William</h3>
                                                <span>Graphic Designer</span>
                                        ...
                                        <div class="request-details">
                                            <div class="noty-user-img">
                                                <img src="{{ asset('front/images/resources/r-img6.png') }}" alt="">
                                            </div>
                                            <div class="request-info">
                                                <h3>John Doe</h3>
                                                <span>PHP Developer</span>
